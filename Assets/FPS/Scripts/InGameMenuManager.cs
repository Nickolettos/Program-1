...
public class InGameMenuManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        /* Using Player Preferences to load previously saved sensitivity */
        //lookSensitivitySlider.value = m_PlayerInputsHandler.lookSensitivity;
        lookSensitivitySlider.value = PlayerPrefs.GetFloat("Sensitivity", 1f);
        m_PlayerInputsHandler.lookSensitivity = lookSensitivitySlider.value;
    ...
    void OnMouseSensitivityChanged(float newValue)
    {
        ...
        PlayerPrefs.SetFloat("Sensitivity", m_PlayerInputsHandler.lookSensitivity);
    }
